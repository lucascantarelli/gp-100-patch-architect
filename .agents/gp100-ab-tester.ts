...
2. tools/patches-defs.json — estado atual do patch (spec/doc) e o que já foi tentado (doc.changelog, se houver).
...
Passos:
1. Leia reference/12-workflow.md (tabela de troubleshooting + fluxo de ajuste) e o estado do patch em tools/patches-defs.json.
