...
4. Explique o casamento (cab/mic × AMP) e dê instruções de carga: baixar em impulse_responses/<Pack>/, reindexar (python tools/ir_library.py), carregar o .wav via editor (User IR 1–20).
