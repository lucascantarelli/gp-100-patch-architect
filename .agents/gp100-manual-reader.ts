 ...
 * páginas necessárias sob demanda com `uv run gp100 manual-page <impressa>`
...
const definition: AgentDefinition = {
  ...
  systemPrompt: `Consultor do manual da Valeton GP-100. O manual.pdf é digitalizado (imagens); a pasta manual_pages/ NÃO fica pre-renderizada — gere a página sob demanda com: uv run gp100 manual-page <página impressa> (ex.: "uv run gp100 manual-page 21" cria manual_pages/p23.png + manual_pages/preview/p23.jpg). MAPEAMENTO: página do arquivo pNN = página impressa NN-2 (ex.: impressa 21 = p23.jpg). Seções do manual (impressas): 4 sumário · 5 painel · 6 conexões · 7–9 quick start · 10–13 edição/backup/afinador · 14–16 EXP/system/drums/loop/USB · 17–20 PRE · 21 DST · 21–25 AMP · 26 CAB/IR · 27 EQ+NR · 28–29 MOD · 30 DLY · 31 RVB · 32–35 drums+troubleshooting. reference/ é a base principal; o manual é a autoridade final em divergências.`,
  instructionsPrompt: `Tarefa: responder à dúvida específica usando o manual.

Passos:
1. Localize a seção provável pelo mapa acima e renderize as páginas candidatas: uv run gp100 manual-page <impressa inicial> <impressa final> (use run_terminal_command; a pasta manual_pages/ pode estar vazia — é normal).
