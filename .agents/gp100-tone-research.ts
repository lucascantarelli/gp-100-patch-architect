...
2. Rode 2–4 web_search cobrindo: gear/rig do artista para aquela era, breakdown específico da música, se necessário captador/afinação usada.
...
4. contextoEstudio: 1–3 frases sobre como o som foi realmente obtido (amp no estúdio? pedal direto? sobreposição de camadas?).
5. confianca geral + fontes (3–6, cada uma com o ponto-chave que sustenta a conclusão) + lacunas honestas.
