...
1. Arpejos lentos e uniformes (C–E–G–B) — cada nota deve durar a mesma coisa
2. Não separe as notas: o Chorus + Hall criam o 'tecido' sozinhos

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U12** (seção 8).
> 3. Toque *intro completa* e confira o checklist da seção 5.
...
**O que este patch é**: Arpejo líquido: Chorus lento sobre Twin limpo + Hall — o Leslie da Abbey Road.

George no Les Paul 'Lucy' com Leslie: arpejos giratórios etéreos, coro de 3 vozes. O Chorus lento imita o rotary.

**Teste recomendado**: intro completa · **Drum**: nenhum

**Como saber que está certo**:

- ☑️ girar etéreo
- ☑️ cada nota do arpejo separada
...
|---|---|---|
| George: Les Paul Lucy + Leslie 147RV | alta | Guitar World — Abbey Road gear guide |
| Arpejos em C com Moog de fundo | alta | Guitar World |
...
|---|---|---|---|---|---|---|---|---|
| ~~⚪~~ PRE | ~~⚪~~ DST | **🔴** AMP · Dark Twin | **🔴** NR · Gate 1 | **🔴** CAB · DarkTW 2x12 | **🔴** EQ · EQ 1 | **🔴** MOD · A-Chorus | ~~⚪~~ DLY | **🔴** RVB · Hall |
...
|---|---|---|
| AMP | Dark Twin | Vol: 46 · Output: 62 · Bass: 52 · Middle: 48 · Treble: 55 · Bright: Off |
| NR | Gate 1 | Thr: 20 |
...
**Nome no painel**: `BCS01AR` · **Slot sugerido**: **U12**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U12**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Dark Twin` (Vol 46 / Output 62 / Bass 52 / Middle 48 / Treble 55 / Bright Off) → **NR** `Gate 1` (Thr 20) → **CAB** `DarkTW 2x12` (Level 75 / High Cut 50) → **EQ** `EQ 1` (Low 0 / Mid 0 / High 0 / Level 50) → **MOD** `A-Chorus` (Rate 30 / Depth 0.5 / Mix 50 / Level 0) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `BCS01AR`.

---

## 🚫 9. Evite com este patch

- ⛔ Drive: a faixa é etérea e limpa
