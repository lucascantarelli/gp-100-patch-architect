...
> 💡 **Limpo rápido e charmoso: Twin com Room curto, puro dedilhado**
...
1. Dedilhado rápido em A–D–E com o pulo de semitom final
2. Leveza e humor — é o 'post-scriptum' debochado do álbum

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U20** (seção 8).
> 3. Toque *faixa completa (23 s)* e confira o checklist da seção 5.
...
**O que este patch é**: Limpo rápido e charmoso: Twin com Room curto, puro dedilhado.

Esboço de 23 segundos: Paul no Casino (ou Martin?) limpo e rápido. Limpo e charmoso.

**Teste recomendado**: faixa completa (23 s) · **Drum**: nenhum
...
|---|---|---|
| Paul: guitarra limpa rápida | média | Guitar World |
...
**Nome no painel**: `HM201CL` · **Slot sugerido**: **U20**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U20**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Dark Twin` (Vol 48 / Output 62 / Bass 50 / Middle 50 / Treble 58 / Bright Off) → **NR** `Gate 1` (Thr 20) → **CAB** `DarkTW 2x12` (Level 75 / High Cut 50) → **EQ** `EQ 1` (Low 0 / Mid 0 / High 0 / Level 50) → **RVB** `Room` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `HM201CL`.
