# 🔨 MAX01FL
### Maxwell's Silver Hammer — Base + fills
##### The Beatles · Abbey Road (1969)

![Genero](https://img.shields.io/badge/Genero-Pop-e02d2d?style=flat-square) ![Camada](https://img.shields.io/badge/Camada-Base-f3a637?style=flat-square) ![Captador](https://img.shields.io/badge/Captador-posição%202-2ea44f?style=flat-square) ![Contexto](https://img.shields.io/badge/Contexto-fone%20%2B%20PC-6f42c1?style=flat-square) ![Formato](https://img.shields.io/badge/.prst-single%20fw%202.1-2ea44f?style=flat-square)

> 💡 **Strat limpa e saltitante em Twin, reverb curto de sala: luz e estilo vaudeville**

---

## 🎸 1. Sua guitarra agora — leia isto primeiro

> **⚡ Ajuste a Strat antes de tocar: Seletor 2 (bridge+middle) · Volume 7–8 · Tone 9**

| Controle na guitarra | Ajuste |
|---|---|
| **Seletor de captadores** | Posição 2 — bridge+middle (brilho com corpo) |
| **Volume** | 7–8 |
| **Tone** | 9 |

**🎯 Técnica que completa o som** (a dinâmica da mão vale tanto quanto os parâmetros):

1. Acordes curtos e saltitantes (staccato) — solte a corda entre as batidas
2. Fills cromáticos respondem o vocal: toque baixo e deixe a 'resposta' no mesmo volume

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U05** (seção 8).
> 3. Toque *estrofe + resposta 'Maxwell's silver hammer'* e confira o checklist da seção 5.
...
**Nota específica deste patch**: Twin padrão — a captura local (User IR 1) é opcional; a fábrica já entrega o alvo.
...
**O que este patch é**: Strat limpa e saltitante em Twin, reverb curto de sala: luz e estilo vaudeville.

Vaqueirinha de vaudeville: George em Strat/Tele limpa com Twin, fills alegres e debochados. Sem drive nenhum.

**Teste recomendado**: estrofe + resposta 'Maxwell's silver hammer' · **Drum**: Pop 88 BPM

**Como saber que está certo**:

- ☑️ nota separada da nota, estilo percussivo
- ☑️ fills respondendo o vocal
...
|---|---|---|
| George: Stratocaster (a mesma dos ensaios em Twickenham) | média | Guitar World — Abbey Road gear guide |
| Twin limpo, sem pedais | alta | boostguitarpedals |
...
|---|---|---|---|---|---|---|---|---|
| ~~⚪~~ PRE | ~~⚪~~ DST | **🔴** AMP · Dark Twin | **🔴** NR · Gate 1 | **🔴** CAB · DarkTW 2x12 | **🔴** EQ · EQ 1 | ~~⚪~~ MOD | ~~⚪~~ DLY | **🔴** RVB · Room |
...
|---|---|---|
| AMP | Dark Twin | Vol: 48 · Output: 62 · Bass: 50 · Middle: 50 · Treble: 58 · Bright: Off |
| NR | Gate 1 | Thr: 22 |
...
**Nome no painel**: `MAX01FL` · **Slot sugerido**: **U05**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U05**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Dark Twin` (Vol 48 / Output 62 / Bass 50 / Middle 50 / Treble 58 / Bright Off) → **NR** `Gate 1` (Thr 22) → **CAB** `DarkTW 2x12` (Level 75 / High Cut 50) → **EQ** `EQ 1` (Low 0 / Mid 0 / High 0 / Level 50) → **RVB** `Room` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `MAX01FL`.

---

## 🚫 9. Evite com este patch

- ⛔ Drive: a faixa é 100% limpa
