# 🔥 MM1001BA
### Sun King / Mean Mr. Mustard — Base (Mean Mr. Mustard)
...
> 💡 **Crunch gritado do Casino no AC30 (mesma alma do Oh! Darling, menos slapback)**
...
1. Riff em E com palm-mute e acordes secos — humor debochado, pegada firme
2. Mudança para A no 'stand up' com ataque total

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U14** (seção 8).
> 3. Toque *trecho 'Mean Mr. Mustard'* e confira o checklist da seção 5.
...
**O que este patch é**: Crunch gritado do Casino no AC30 (mesma alma do Oh! Darling, menos slapback).

Sun King: arpejos etéreos com Leslie no Lucy. Mean Mr. Mustard: rock gritado no Casino — duas metades, dois patches.

**Teste recomendado**: trecho 'Mean Mr. Mustard' · **Drum**: Rock 100 BPM
...
**Nome no painel**: `MM1001BA` · **Slot sugerido**: **U14**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U14**.
...
3. **SAVE** no slot → renomeie para `MM1001BA`.

---

## 🚫 9. Evite com este patch

- ⛔ Reverb longo — a faixa é seca
