# 🌅 SKG01CL
### Sun King / Mean Mr. Mustard — Clean (Sun King)
...
> 💡 **Arpejos do Lucy girando: Chorus lento + Hall profundo, quase onírico**
...
1. Arpejos em 3ªs — destaque a voz superior (a melodia que 'canta')
2. Dinâmica constante e contemplativa, quase sem ataque

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U13** (seção 8).
> 3. Toque *intro de Sun King* e confira o checklist da seção 5.
...
|---|---|
| mais éter | RVB Mix 60 |
| menos girar | Chorus OFF |
...
**O que este patch é**: Arpejos do Lucy girando: Chorus lento + Hall profundo, quase onírico.

Sun King: arpejos etéreos com Leslie no Lucy. Mean Mr. Mustard: rock gritado no Casino — duas metades, dois patches.

**Teste recomendado**: intro de Sun King · **Drum**: nenhum

**Como saber que está certo**:

- ☑️ flutuação rotativa
- ☑️ harmonia doce
...
|---|---|---|
| Sun King: Lucy + Leslie | alta | Guitar World |
| Mean Mr. Mustard: Casino crujido | média | Guitar World |
...
**Nome no painel**: `SKG01CL` · **Slot sugerido**: **U13**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U13**.
...
3. **SAVE** no slot → renomeie para `SKG01CL`.

---

## 🚫 9. Evite com este patch

- ⛔ Velocidade do chorus acima de 0.5
