# 🎹 YNG01AR
### You Never Give Me Your Money — Arpejos limpos
...
> 💡 **Arpejos crescentes em Am: Twin limpo com Room curto e leve tremolo do atacado**

---

## 🎸 1. Sua guitarra agora — leia isto primeiro

> **⚡ Ajuste a Strat antes de tocar: Seletor 4 (middle+neck) · Volume 8 · Tone 8**
...
1. Arpejos em Am com crescendo de dinâmica (as notas 'acordam' aos poucos)
2. No trecho 'one two three four five', brinque com o knob de Volume

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U15** (seção 8).
...
**O que este patch é**: Arpejos crescentes em Am: Twin limpo com Room curto e leve tremolo do atacado.
...
|---|---|---|
| AMP | Dark Twin | Vol: 48 · Output: 62 · Bass: 52 · Middle: 48 · Treble: 56 · Bright: Off |
| NR | Gate 1 | Thr: 20 |
...
**Nome no painel**: `YNG01AR` · **Slot sugerido**: **U15**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U15**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Dark Twin` (Vol 48 / Output 62 / Bass 52 / Middle 48 / Treble 56 / Bright Off) → **NR** `Gate 1` (Thr 20) → **CAB** `DarkTW 2x12` (Level 75 / High Cut 50) → **EQ** `EQ 1` (Low 0 / Mid 0 / High 0 / Level 50) → **RVB** `Room` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `YNG01AR`.

---

## 🚫 9. Evite com este patch

- ⛔ Chorus — o ADT da gravação está no vocal, não na guitarra
