...
> 💡 **Gurley solo: Boost + Blues OD 55 + Dark Twin Vol 78, spring aberto e Vibe OFF (opcional para improviso)**

---

## 🎸 1. Sua guitarra agora — leia isto primeiro

> **⚡ Ajuste a Strat antes de tocar: Seletor 1 (bridge) · Volume 10 · Tone 9**

| Controle na guitarra | Ajuste |
|---|---|
| **Seletor de captadores** | Posição 1 — bridge (mordida e feedback) |
| **Volume** | 10 |
| **Tone** | 9 |

**🎯 Técnica que completa o som** (a dinâmica da mão vale tanto quanto os parâmetros):

1. Volume 10: os sustains aninham sozinhos e o feedback nasce fácil
2. Na nota final, alivie a mão direita e deixe o amp sustentar (é o efeito Gurley)

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U24** (seção 8).
> 3. Toque *solo oficial + improviso estilo Carousel Ballroom* e confira o checklist da seção 5.
...
**Nota específica deste patch**: Recomendada: American Twin 2x12 Medium Mix (User IR 1); para o solo, o Bright Mix também rende (High Cut 7500).
...
**O que este patch é**: Gurley solo: Boost + Blues OD 55 + Dark Twin Vol 78, spring aberto e Vibe OFF (opcional para improviso).

Sam Andrew (SG + Twin estufado) na base quebrada; James Gurley no solo com sustain e feedback. Zero pedais — tudo é amp.

**Teste recomendado**: solo oficial + improviso estilo Carousel Ballroom · **Drum**: Rock 128 BPM

**Como saber que está certo**:

- ☑️ sustain ≥ 4 s sem digitar forte
- ☑️ feedback ao encostar na ponte
- ☑️ bends sem fizz
...
|---|---|---|---|---|---|---|---|---|
| **🔴** PRE · Boost | **🔴** DST · Blues OD | **🔴** AMP · Dark Twin | **🔴** NR · Gate 1 | **🔴** CAB · DarkTW 2x12 | **🔴** EQ · EQ 1 | ~~⚪~~ MOD | ~~⚪~~ DLY | **🔴** RVB · Spring |
...
|---|---|---|
| PRE | Boost | Ganho: 35 · Boost: 1 |
| DST | Blues OD | Gain: 55 · Tone: 60 · Level: 70 |
| AMP | Dark Twin | Vol: 78 · Output: 62 · Bass: 52 · Middle: 55 · Treble: 50 · Bright: Off |
| NR | Gate 1 | Thr: 30 |
...
**Nome no painel**: `PMH01SO` · **Slot sugerido**: **U24**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U24**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**PRE** `Boost` (Ganho 35 / Boost 1) → **DST** `Blues OD` (Gain 55 / Tone 60 / Level 70) → **AMP** `Dark Twin` (Vol 78 / Output 62 / Bass 52 / Middle 55 / Treble 50 / Bright Off) → **NR** `Gate 1` (Thr 30) → **CAB** `DarkTW 2x12` (Level 75 / High Cut 50) → **EQ** `EQ 1` (Low -1 / Mid 3 / High -1 / Level 50) → **RVB** `Spring` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `PMH01SO`.

---

## 🚫 9. Evite com este patch

- ⛔ AMP Vol ≥ 85 — gate 'cuspe' ruído
- ⛔ Vibe + reverb aberto juntos
