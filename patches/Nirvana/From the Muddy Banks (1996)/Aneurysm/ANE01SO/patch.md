...
1. Frases longas com vibrato largo, sem pressa
2. Deixe a distorção trabalhar os harmônicos

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U71** (seção 8).
...
|---|---|
| gelando | Tone 8 |
| engolindo o baixo | La Charger Level -3 |
...
**O que este patch é**: Solo de fechamento: jam livre — distorção solta, vibrato largo.

Quiet-loud: arpejo quebrado no verso, explosão no refrão, solo de jam no final.

**Teste recomendado**: solo final · **Drum**: grunge 90 bpm

**Como saber que está certo**:

- ☑️ lead solto sobre a jam
- ☑️ vibrato largo carregando a frase
...
|---|---|---|
| DST | La Charger | Gain: 70 · Tone: 52 · Volume: 64 |
...
**Nome no painel**: `ANE01SO` · **Slot sugerido**: **U71**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U71**.
