...
> **⚡ Ajuste a Strat antes de tocar: SELETOR 4 · Volume 9 · Tone 7**
...
1. Toque o colchão de acordes com a mão solta
2. Deixe o chorus e a mão direita fazerem o embalo

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U84** (seção 8).
> 3. Toque *verso (colchão)* e confira o checklist da seção 5.
...
1. **Refrão pesado** — **DST → ON**
   *Quando*: Refrão: DST ON = parede de DS-1.
   *Dica*: O colchão do verso volta com DST OFF.

2. **Solo punk** — **MOD → OFF**
   *Quando*: Solo do meio: chorus sai para o lead morder.
...
**O que este patch é**: Verso: o colchão limpo entre as explosões — _o quiet-loud mais famoso de In Utero_.

Colchão limpo no verso, parede de DS-1 no refrão (Seattle 1993).

**Teste recomendado**: verso (colchão) · **Drum**: grunge 100 bpm

**Como saber que está certo**:

- ☑️ colchão limpo embalado
- ☑️ explosão do refrão por cima
...
| RVB | Room | Mix: 20 · Pre Delay: 17 ms · Decay: 30 · Trail: Off |
...
**Nome no painel**: `HSB01AR` · **Slot sugerido**: **U84**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U84**.
