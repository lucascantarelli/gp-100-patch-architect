# ⚡ HSB01RI
### Heart-Shaped Box — Refrão Pesado
...
1. Palhetada total e para baixo
2. Deixe o Room curto dar a sala do show

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U85** (seção 8).
> 3. Toque *refrão ('hey! wait!')* e confira o checklist da seção 5.
...
1. **Verso claro** — **DST → OFF** + **MOD → ON**
   *Quando*: O verso é colchão limpo com chorus — um stomp só.
   *Dica*: É o HSB01AR sem trocar de patch.

2. **Solo** — **EQ → ON**
   *Quando*: Sobressalente: realce para as frases do meio.
...
**O que este patch é**: Refrão: DS-1 no talo com o grave da single coil mordendo.

Colchão limpo no verso, parede de DS-1 no refrão (Seattle 1993).

**Teste recomendado**: refrão ('hey! wait!') · **Drum**: grunge 100 bpm

**Como saber que está certo**:

- ☑️ parede de som com o grave presente
- ☑️ corte seco no fim do refrão
...
|---|---|---|
| DST | La Charger | Gain: 66 · Tone: 44 · Volume: 62 |
