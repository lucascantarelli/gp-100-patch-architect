...
> 💡 **O riff mais copyado do grunge: três acordes estourados, ganho no limite do lo-fi — _DS-1 direto no Twin_**

---

## 🎸 1. Sua guitarra agora — leia isto primeiro

> **⚡ Ajuste a Strat antes de tocar: SELETOR 3 · Volume 10 · Tone 10 (aberto, sem dó)**
...
1. Palhetada FORTE e para baixo — o DS-1 vive da agressividade da mão
2. Deixe as notas se embolarem um pouco: é o som do disco

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U64** (seção 8).
> 3. Toque *riff da intro* e confira o checklist da seção 5.
...
|---|---|
| chipando demais | La Charger Gain -4 |
| falta corpo | EQ Mid +3 |
...
1. **Solo sujo** — **EQ → ON**
   *Quando*: Sobressalente: realce de médios para o solo central.
...
**O que este patch é**: O riff mais copyado do grunge: três acordes estourados, ganho no limite do lo-fi — _DS-1 direto no Twin_.

O riff mais copyado do grunge: três acordes, ganho no teto, solo central.

**Teste recomendado**: riff da intro · **Drum**: punk rápido 160 bpm

**Como saber que está certo**:

- ☑️ três acordes estourados e embolados
- ☑️ ring do Room curto após o corte
...
|---|---|---|
| DST | La Charger | Gain: 62 · Tone: 42 · Volume: 62 |
...
**Nome no painel**: `SCH01RI` · **Slot sugerido**: **U64**
...
```
**DST** `La Charger` (Gain 62 / Tone 42 / Volume 62) → **AMP** `Dark Twin` (Vol 55 / Output 62 / Bass 52 / Middle 48 / Treble 55 / Bright Off) → **NR** `Gate 1` (Thr 26) → **CAB** `DarkTW 2x12` (Level 75 / High Cut 50) → **RVB** `Room` (ajuste fino no painel — seção 3 📡) → SOBRESSALENTE **EQ** `EQ 1` (Mid 3 / Level 56)
```

3. **SAVE** no slot → renomeie para `SCH01RI`.
