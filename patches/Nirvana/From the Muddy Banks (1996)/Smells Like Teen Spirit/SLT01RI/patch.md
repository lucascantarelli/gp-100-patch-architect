# ⚡ SLT01RI
### Smells Like Teen Spirit — Riff Punk
...
1. Palhetada para baixo, com STOP seco no "hello, hello…"
2. Segure o acorde no staccato: o espaço é parte do riff

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U73** (seção 8).
> 3. Toque *riff principal* e confira o checklist da seção 5.
...
1. **Verso limpo** — **DST → OFF** + **MOD → ON**
   *Quando*: O verso é LIMPO com chorus — o erro clássico é tocar sujo.
   *Dica*: Mesma ideia do SLT01CL em um stomp.

2. **Solo** — **EQ → ON**
   *Quando*: Sobressalente para o solo gaguejado.
...
**O que este patch é**: O riff do século: F–Bb–Ab–Db com DS-1 e ataque total.

O hino: verso limpo com chorus (o erro clássico é tocar sujo), refrão de DS-1, solo gaguejado.

**Teste recomendado**: riff principal · **Drum**: grunge 117 bpm

**Como saber que está certo**:

- ☑️ quatro acordes com peso máximo
- ☑️ corte seco no break
...
|---|---|---|
| DST | La Charger | Gain: 66 · Tone: 48 · Volume: 62 |
