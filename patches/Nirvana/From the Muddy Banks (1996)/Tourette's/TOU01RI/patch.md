...
1. Palhetada total, sem pausa para respirar
2. É gritado na voz E na guitarra: tudo no máximo

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U91** (seção 8).
> 3. Toque *música inteira* e confira o checklist da seção 5.
...
1. **Meio-tempo** — **DST → OFF**
   *Quando*: Se ensaiar mais devagar, DST OFF = crunch limpo.
   *Dica*: Caos volta com DST ON.
...
**O que este patch é**: O caos de 1:30 do Reading '92: screamo punk, sem respiro.

90 segundos de caos punk do Reading '92 — gritado na voz e na guitarra.

**Teste recomendado**: música inteira · **Drum**: screamo 170 bpm

**Como saber que está certo**:

- ☑️ caos alegre e controlado
- ☑️ energia sem pausa por 90 segundos
...
**Nome no painel**: `TOU01RI` · **Slot sugerido**: **U91**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U91**.
...
3. **SAVE** no slot → renomeie para `TOU01RI`.
