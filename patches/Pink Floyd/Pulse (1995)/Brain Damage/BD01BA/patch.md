...
1. Acordes D/F# com palhetada folk
2. Deixe as cordas soar entre as trocas

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U55** (seção 8).
...
**O que este patch é**: Base folk: acordes abertos com brilho — o lado leve e sombrio do DSOTM.

Base folk do DSOTM: acordes abertos com brilho, clima leve e sombrio ao mesmo tempo.

**Teste recomendado**: acordes dos versos e refrão · **Drum**: DSOTM 77 BPM

**Como saber que está certo**:

- ☑️ brilho folk
- ☑️ boa definição nos acordes abertos
...
|---|---|---|
| Base folk com acordes abertos | alta | Pulse (1995) · gilmourish.com |
...
**Nome no painel**: `BD01BA` · **Slot sugerido**: **U55**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U55**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Knights CL` (Gain 38 / Vol 62 / Bass 62 / Middle 48 / Treble 52 / p5 58) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡) → SOBRESSALENTE **DLY** `Sweet` (template de fábrica — ajuste por orelha ao ligar)
```

3. **SAVE** no slot → renomeie para `BD01BA`.
