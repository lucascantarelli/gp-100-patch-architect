...
> **⚡ Ajuste a Strat antes de tocar: SELETOR 4 · Volume 8 · Tone 8**
...
1. Arpejos em 6/8 com palhetada híbrida
2. Cresça de volume a cada volta do ciclo

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U36** (seção 8).
> 3. Toque *arpejos da intro e versos* e confira o checklist da seção 5.
...
1. **Ponte seca** — **DLY → OFF**
   *Quando*: Seção pontual sem eco (a base dos arpejos volta com DLY ON).
...
**O que este patch é**: Arpejos de abertura: limpo com delay — o despertar em 6/8.

Arpejos limpos com delay que crescem para o solo épico — a ressurreição do álbum.

**Teste recomendado**: arpejos da intro e versos · **Drum**: Rock 104 BPM

**Como saber que está certo**:

- ☑️ arpejos com eco respondendo
- ☑️ dinâmica crescendo
...
|---|---|---|
| Arpejos de abertura com delay; solo com Tube Driver | alta | Pulse (1995) · gilmourish.com |
...
| DLY | Sweet | Fdbk: 15 · Delay ms: 430 · High Cut: 25 |
...
**Nome no painel**: `CBK01AR` · **Slot sugerido**: **U36**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U36**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Knights CL` (Gain 38 / Vol 62 / Bass 62 / Middle 48 / Treble 52 / p5 58) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **DLY** `Sweet` (Fdbk 15 / Delay ms 430 / High Cut 25) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `CBK01AR`.
