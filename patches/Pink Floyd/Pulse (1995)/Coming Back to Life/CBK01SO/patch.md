...
**O que este patch é**: Solo principal: Tube Driver quente + delay — a frase longa que abre o céu.
...
**Nome no painel**: `CBK01SO` · **Slot sugerido**: **U37**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U37**.
...
3. **SAVE** no slot → renomeie para `CBK01SO`.
