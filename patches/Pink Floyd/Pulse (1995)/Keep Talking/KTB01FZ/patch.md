...
```
**DST** `Red Haze` (p0 62 / p1 45 / p2 55) → **AMP** `Flagman` (p0 40 / p1 50 / p2 58 / p3 50 / p4 52 / p5 56) → **NR** `Gate 1` (Thr 30) → **CAB** `UK-LD 4x12` (p0 78 / p1 62) → **DLY** `Sweet` (Fdbk 12 / Delay ms 570 / High Cut 22) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
