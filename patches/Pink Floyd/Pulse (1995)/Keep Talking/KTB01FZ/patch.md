...
```
**DST** `Red Haze` (Fuzz 62 / VOL 45) → **AMP** `Flagman` (Gain 40 / PRSE 50 / Master 58 / Bass 50 / Middle 52 / Treble 56) → **NR** `Gate 1` (Thr 30) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **DLY** `Sweet` (Mix 12 / Time 570 ms / Fdbk 22) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
