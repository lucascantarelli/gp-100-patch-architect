...
```
**PRE** `Saturate` (p0 50 / p1 60 / p2 62) → **AMP** `Flagman` (Gain 50 / PRSE 58 / Master 64 / Bass 50 / Middle 55 / Treble 58) → **NR** `Gate 1` (Thr 30) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **DLY** `Sweet` (Fdbk 20 / Delay ms 570 / High Cut 30) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
