...
```
**PRE** `Saturate` (p0 50 / p1 60 / p2 62) → **AMP** `Flagman` (p0 50 / p1 58 / p2 64 / p3 50 / p4 55 / p5 58) → **NR** `Gate 1` (Thr 30) → **CAB** `UK-LD 4x12` (p0 78 / p1 62) → **DLY** `Sweet` (Fdbk 20 / Delay ms 570 / High Cut 30) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
