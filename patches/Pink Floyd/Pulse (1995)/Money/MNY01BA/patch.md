...
1. Conte o 7/4: 1-2-3-4-5-6-7 (não force o 4/4)
2. Riff com palhetada alternada

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U50** (seção 8).
> 3. Toque *riff e refrões no 7/4* e confira o checklist da seção 5.
...
1. **Solo (eco)** — **DLY → ON**
   *Quando*: Solo do 7/4 com o eco do projeto.
...
**O que este patch é**: Base do 7/4: crunch firme e groove — o blues do dinheiro.

O blues de 7/4: solo com TD + delay, base com crunch e aquele groove irregular.

**Teste recomendado**: riff e refrões no 7/4 · **Drum**: Blues 7/4

**Como saber que está certo**:

- ☑️ crunch firme no groove
- ☑️ graves definidos
...
**Nome no painel**: `MNY01BA` · **Slot sugerido**: **U50**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U50**.
...
3. **SAVE** no slot → renomeie para `MNY01BA`.
