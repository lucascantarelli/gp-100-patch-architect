...
1. Frases no 7/4 com pausas
2. Bend de meio tom no final das frases

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U51** (seção 8).
...
1. **Groove seco** — **DLY → OFF**
   *Quando*: Riff do 7/4 seco — definição total.
...
**O que este patch é**: Solo de Money: Tube Driver quente + delay — o blues de 7/4 com frases que caem no groove.

O blues de 7/4: solo com TD + delay, base com crunch e aquele groove irregular.

**Teste recomendado**: solo central · **Drum**: Blues 7/4

**Como saber que está certo**:

- ☑️ frases que caem no groove 7/4
- ☑️ bend com sustain
...
|---|---|---|
| Solo TD+delay; base crunch no 7/4 | alta | Pulse (1995) · gilmourish.com |
...
**Nome no painel**: `MNY01SO` · **Slot sugerido**: **U51**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U51**.
...
3. **SAVE** no slot → renomeie para `MNY01SO`.
