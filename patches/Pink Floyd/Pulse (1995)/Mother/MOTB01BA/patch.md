...
1. Arpejos com a mão relaxada
2. Deixe cada nota soar completa

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U60** (seção 8).
> 3. Toque *arpejos dos versos* e confira o checklist da seção 5.
...
**O que este patch é**: Base da balada: arpejos limpos com reverb — o colchão da pergunta à mãe.

A balada do muro: acordes limpos com arpejos e clima de pergunta à mãe.

**Teste recomendado**: arpejos dos versos · **Drum**: Balada 81 BPM

**Como saber que está certo**:

- ☑️ arpejos limpos e definidos
- ☑️ reverb respirando
...
|---|---|---|
| Base limpa com arpejos + clima de balada | alta | Pulse (1995) · gilmourish.com |
...
**Nome no painel**: `MOTB01BA` · **Slot sugerido**: **U60**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U60**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Knights CL` (Gain 38 / Vol 62 / Bass 62 / Middle 48 / Treble 52 / p5 58) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `MOTB01BA`.
