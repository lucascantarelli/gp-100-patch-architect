...
| DLY | Sweet | Mix: 25 · Time: 530 ms · Fdbk: 26 |
| RVB | Hall | Mix: 35 · Pre Delay: 45 ms · Decay: 50 · Trail: On |
...
```
**AMP** `Knights CL` (Gain 38 / Vol 62 / Bass 62 / Middle 48 / Treble 52) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **DLY** `Sweet` (Mix 25 / Time 530 ms / Fdbk 26) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
