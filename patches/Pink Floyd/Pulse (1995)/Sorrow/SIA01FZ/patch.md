...
1. Acordes com intervalos largos (D5+10ª)
2. Sustain longo com vibrato do braço

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U38** (seção 8).
> 3. Toque *intro e feitiço* e confira o checklist da seção 5.
...
1. **Verso (crunch)** — **DST → OFF**
   *Quando*: Versos de crunch do Flagman; DST ON = intro/solo de fuzz.
   *Dica*: Este é o patch "música inteira" de Sorrow.
...
**O que este patch é**: Intro gigante: Big Muff em acordes com intervalos largos — o feitiço que abre o show.

A abertura épica do Division Bell: Big Muff em acordes gigantes e solo final pesado.

**Teste recomendado**: intro e feitiço · **Drum**: Épico 116 BPM

**Como saber que está certo**:

- ☑️ acordes de fuzz gigantes
- ☑️ sustain sem fim
...
|---|---|---|---|---|---|---|---|---|
| ~~⚪~~ PRE | **🔴** DST · Red Haze | **🔴** AMP · Flagman | **🔴** NR · Gate 1 | **🔴** CAB · UK-LD 4x12 | ~~⚪~~ EQ | ~~⚪~~ MOD | ~~⚪~~ DLY | **🔴** RVB · Hall |
...
**Nome no painel**: `SIA01FZ` · **Slot sugerido**: **U38**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U38**.
