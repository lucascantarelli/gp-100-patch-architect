# 🎺 GGS01AM
### The Great Gig in the Sky — Texturas
...
> **⚡ Ajuste a Strat antes de tocar: VOLUME 5-7 · Seletor 4 · Tone 7 (suave, atrás do vocal)**
...
1. Swells discretos seguindo a dinâmica do vocal
2. Menos é mais — sombra, não protagonista

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U49** (seção 8).
> 3. Toque *texturas suaves e swells* e confira o checklist da seção 5.
...
|---|---|
| brigar com o vocal | toque quase nada |
| muito presente | VOL da guitarra -2 |
...
**O que este patch é**: Ambiente etéreo: chorus + reverb longo — camada sutil que respeita o vocal da faixa.

Sem guitarra na faixa (piano + vocal improvisado) — patch de ambiente para camadas caseiras.

**Teste recomendado**: texturas suaves e swells · **Drum**: Balada

**Como saber que está certo**:

- ☑️ camada sutil sem brigar com o vocal
- ☑️ clima etéreo
...
|---|---|---|
| Sem guitarra: piano elétrico e vocal improvisado | alta | Pulse (1995) · gilmourish.com |
...
**Nome no painel**: `GGS01AM` · **Slot sugerido**: **U49**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U49**.
2. **Digitar no painel** (receita na ordem dos menus):

```
**AMP** `Knights CL` (Gain 38 / Vol 62 / Bass 62 / Middle 48 / Treble 52 / p5 58) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **MOD** `A-Chorus` (Rate 28 / Depth 0.5 / Mix 28) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `GGS01AM`.
