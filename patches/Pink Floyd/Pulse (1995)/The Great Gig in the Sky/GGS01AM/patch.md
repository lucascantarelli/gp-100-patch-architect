...
```
**AMP** `Knights CL` (p0 38 / p1 62 / p2 62 / p3 48 / p4 52 / p5 58) → **CAB** `UK-LD 4x12` (p0 78 / p1 62) → **MOD** `A-Chorus` (Rate 28 / Depth 0.5 / Mix 28) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
