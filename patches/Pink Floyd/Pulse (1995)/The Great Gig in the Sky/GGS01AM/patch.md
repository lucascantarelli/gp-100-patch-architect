...
```
**AMP** `Knights CL` (Gain 38 / Vol 62 / Bass 62 / Middle 48 / Treble 52) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **MOD** `A-Chorus` (Rate 28 / Depth 0.5 / Mix 28) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
