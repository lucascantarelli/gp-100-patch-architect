...
1. Acordes com palhetada suave
2. Deixe os acordes soar completos

> 🚀 **Comece por aqui (3 passos)**:
> 1. Ajuste a guitarra conforme a tabela acima.
> 2. Carregue o patch no slot **U52** (seção 8).
> 3. Toque *acordes dos versos* e confira o checklist da seção 5.
...
1. **Solo aéreo** — **DLY → ON**
   *Quando*: Frases sobre a balada — o eco completa o vazio.
...
**O que este patch é**: Base da balada: limpo com chorus e reverb amplo — o colchão de piano e sax.

A balada épica: base limpa com chorus e reverb, solos aéreos com delay.

**Teste recomendado**: acordes dos versos · **Drum**: Balada épica
...
|---|---|---|
| Base limpa com chorus e reverb; solos aéreos | alta | Pulse (1995) · gilmourish.com |
...
**Nome no painel**: `USAT01BA` · **Slot sugerido**: **U52**

1. **GP-100 Edits (recomendado)**: conecte a GP-100 por USB → importe `<NOME>.prst` desta pasta → salve no slot **U52**.
...
3. **SAVE** no slot → renomeie para `USAT01BA`.
