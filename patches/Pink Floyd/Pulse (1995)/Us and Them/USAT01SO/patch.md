...
```
**AMP** `Knights CL` (p0 42 / p1 62 / p2 62 / p3 48 / p4 52 / p5 58) → **CAB** `UK-LD 4x12` (p0 78 / p1 62) → **DLY** `Sweet` (Fdbk 20 / Delay ms 570 / High Cut 30) → **RVB** `Hall` (ajuste fino no painel — seção 3 📡)
```
