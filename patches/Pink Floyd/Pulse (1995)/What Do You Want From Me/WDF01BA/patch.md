...
|---|---|---|
| PRE | Saturate | p0: 38 · p1: 55 · p2: 62 |
...
```
**PRE** `Saturate` (p0 38 / p1 55 / p2 62) → **AMP** `Flagman` (Gain 44 / PRSE 55 / Master 62 / Bass 50 / Middle 55 / Treble 58) → **NR** `Gate 1` (Thr 26) → **CAB** `UK-LD 4x12` (Level 78 / High Cut 62) → **RVB** `Plate` (ajuste fino no painel — seção 3 📡) → SOBRESSALENTE **DLY** `Sweet` (Fdbk 15 / Delay ms 430 / High Cut 25)
```
