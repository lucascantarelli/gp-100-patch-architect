...
```
**AMP** `Knights CL` (p0 38 / p1 62 / p2 62 / p3 48 / p4 52 / p5 58) → **CAB** `UK-LD 4x12` (p0 78 / p1 62) → **DLY** `Sweet` (Fdbk 18 / Delay ms 380 / High Cut 20) → **RVB** `Room` (ajuste fino no painel — seção 3 📡)
```
