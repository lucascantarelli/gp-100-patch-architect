...
![Genero](https://img.shields.io/badge/Genero-Rock-e02d2d?style=flat-square) ![Camada](https://img.shields.io/badge/Camada-Riff-f3a637?style=flat-square) ![Captador](https://img.shields.io/badge/Captador-middle-2ea44f?style=flat-square) ![Contexto](https://img.shields.io/badge/Contexto-fone%20%2B%20PC-6f42c1?style=flat-square) ![Formato](https://img.shields.io/badge/.prst-single%20fw%202.1-2ea44f?style=flat-square)

> 💡 **Groove do riff: Lone Star aberto com drive na frente — gordo, liso e festonado, a mão no groove de timba**

---

## 🎸 1. Sua guitarra agora — leia isto primeiro

> **⚡ Ajuste a Strat antes de tocar: SELETOR 3 · Volume 8 · Tone 7 — DRIVE NO STOMP: religue no refrão se quiser o refrão mais aberto**

| Controle na guitarra | Ajuste |
|---|---|
| **Seletor de captadores** | Posição 3 (middle) — mordida sem perder o corpo |
| **Volume** | 8 (groove constante) |
| **Tone** | 7 |

**🎯 Técnica que completa o som** (a dinâmica da mão vale tanto quanto os parâmetros):

1. Palhetada alternada na corda A/D — o riff vive da mão direita
2. Toque À FRENTE da batida nas transições Am→D (o empurrão do groove)
...
|---|---|
| lamacento | CAB High Cut -5 ou EQ Mid -2 |
| seco/durpo | Yellow OD Tone +5 |
...
1. **Refrão aberto (sem drive)** — **DST → OFF**
   *Quando*: No refrão, desligue o drive: o Lone Star aberto engrossa sem a mordida.
   *Dica*: Religue para o riff.
...
**O que este patch é**: Groove do riff: Lone Star aberto com drive na frente — gordo, liso e festonado, a mão no groove de timba.
...
**Teste recomendado**: riff festonado de Am–D · **Drum**: Rock latino 112 BPM (groove de timba)

**Como saber que está certo**:

- ☑️ gordo e liso ao mesmo tempo
- ☑️ midrange presente que corta sem piar
- ☑️ graves acompanhando o baixo, sem embolar
...
|---|---|---|---|---|---|---|---|---|
| **🔴** PRE · COMP | **🔴** DST · Yellow OD | **🔴** AMP · L-Star CL | **🔴** NR · Gate 1 | **🔴** CAB · L-Star 2x12 | **🔴** EQ · EQ 1 | ~~⚪~~ MOD | ~~⚪~~ DLY | **🔴** RVB · Room |
...
| DST | Yellow OD | Gain: 40 · Tone: 83 · Level: 55 |
| AMP | L-Star CL | Vol: 42 · PRSE: 52 · Master: 62 · Bass: 55 · Middle: 55 · Treble: 58 |
| NR | Gate 1 | Thr: 28 |
...
```
**PRE** `COMP` (Sens 25 / Attack 40 / Sustain 50) → **DST** `Yellow OD` (Gain 40 / Tone 83 / Level 55) → **AMP** `L-Star CL` (Vol 42 / PRSE 52 / Master 62 / Bass 55 / Middle 55 / Treble 58) → **NR** `Gate 1` (Thr 28) → **CAB** `L-Star 2x12` (Level 62 / High Cut 55) → **EQ** `EQ 1` (Low 2 / Mid 3 / High -1 / Mid Freq 5 / Presença 5 / Level 50) → **RVB** `Room` (ajuste fino no painel — seção 3 📡)
```

3. **SAVE** no slot → renomeie para `SMOO1RI`.
