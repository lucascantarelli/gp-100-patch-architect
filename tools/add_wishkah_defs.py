...
Momentos de toggle (os stomps do pedido) são injetados via add_momentos.py —
ver MOMENTOS ali. Idempotente: re-executar remove e reinsere as músicas do
...
# ---------- helpers (construção plana, mesmo formato do add_pulse_defs.py) -------
...
VERSO_LIMPO_CHAIN = chain(amp=TWIN_ON, cab=CAB_TWD, modfx=SMALL,
...
SCHOOL_RIF = P('Riff Punk', 'RI', 'SCH01RI', '🎸',
    ...
    chain(dst=ds1(62, 42, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
...
SCHOOL_SO = P('Solo Sujo', 'SO', 'SCH01SO', '🎸',
    ...
    chain(dst=ds1(66, 45, 64), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 2 (bridge)", "bridge", "10", "10",
...
DRAIN_AR = P('Arpejo Limpo', 'AR', 'DRY01AR', '✨',
    ...
    VERSO_LIMPO_CHAIN, *VERSO_LIMPO_DOC,
...
DRAIN_RIF = P('Refrão Punk', 'RI', 'DRY01RI', '⚡',
    ...
    chain(dst=ds1(64), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
...
DRAIN_SO = P('Solo', 'SO', 'DRY01SO', '🎸',
    ...
    chain(dst=ds1(68, 55, 64), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 2 (bridge)", "bridge", "10", "9",
...
ANE_RIF = P('Refrão Pesado', 'RI', 'ANE01RI', '⚡',
    ...
    chain(dst=ds1(66), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
    "SELETOR 3 · Volume 10 · Tone 10",
...
ANE_SO = P('Solo Livre', 'SO', 'ANE01SO', '🎸',
    ...
    chain(dst=ds1(70, 52, 64), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_MEDIA),
    "Posição 2 (bridge)", "bridge", "10", "10",
    "SELETOR 2 · Volume 10 · Tone 10",
...
SLTS_CL = P('Verso Limpo', 'CL', 'SLT01CL', '✨',
    ...
    chain(amp=TWIN_ON, cab=CAB_TWD, modfx=SMALL, rvb=mod('Room', True, 18, 15, 28, 0)),
    "Posição 3 (bridge+middle)", "bridge+middle", "9", "9",
...
SLTS_SO = P('Solo Gaguejado', 'SO', 'SLT01SO', '🎸',
    ...
    chain(dst=ds1(66, 50, 64), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD,
...
POLLY_CL = P('Clean Espanhol', 'CL', 'POL01CL', '🧺',
    ...
    chain(amp=TWIN_ON, cab=CAB_TWD, rvb=ROOM_CURTA),
...
BREED_RIF = P('Riff Lo-Fi', 'RI', 'BRE01RI', '⚡',
    ...
    chain(dst=ds1(68, 40, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
    "SELETOR 3 · Volume 10 · Tone 10",
...
BEEN_SO = P('Solo Sujo', 'SO', 'BEE01SO', '🎸',
    ...
    chain(dst=ds1(68, 55, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 2 (bridge)", "bridge", "10", "10",
    "SELETOR 2 · Volume 10 · Tone 10",
...
SLIV_AR = P('Intro do Coro', 'AR', 'SLV01AR', '🎺',
    ...
    chain(amp=TWIN_ON, cab=CAB_TWD, modfx=mod('Vibe', True, 45, 0.5, 0), rvb=ROOM_CURTA),
...
SPAN_SO = P('Solo Instrumental', 'SO', 'SPK01SO', '🎸',
    ...
    chain(dst=ds1(66, 50, 64), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_MEDIA),
    "Posição 2 (bridge)", "bridge", "10", "9",
    "SELETOR 2 · Volume 10 · Tone 9",
...
NEGA_RIF = P('Riff Drop D', 'RI', 'NEG01RI', '⚡',
    ...
    chain(dst=ds1(70, 40, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
    "SELETOR 3 · Volume 10 · Tone 10",
...
BLEW_RIF = P('Riff Fuzz', 'RI', 'BLE01RI', '🌊',
    ...
    chain(dst=mod('Red Haze', True, 62, 45), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "7",
...
SCE_RIF = P('Riff Denso', 'RI', 'SCE01RI', '⚡',
    ...
    chain(dst=ds1(68, 42, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
    "SELETOR 3 · Volume 10 · Tone 10",
...
HSB_AR = P('Verso Claro', 'AR', 'HSB01AR', '✨',
    ...
    chain(amp=TWIN_ON, cab=CAB_TWD, modfx=SMALL, rvb=mod('Room', True, 20, 17, 30, 0)),
...
HSB_RIF = P('Refrão Pesado', 'RI', 'HSB01RI', '⚡',
    ...
    chain(dst=ds1(66, 44, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
    "SELETOR 3 · Volume 10 · Tone 10",
...
MIL_RIF = P('Quiet-Loud', 'RI', 'MIL01RI', '⚡',
    ...
    chain(dst=ds1(70, 42, 62), amp=TWIN_ON, nr=GATE1, cab=CAB_TWD, rvb=ROOM_CURTA),
    "Posição 3 (bridge+middle)", "bridge+middle", "10", "10",
    "SELETOR 3 · Volume 10 · Tone 10",
